	...
	public class MapGenerator : MonoBehaviour
	{
		...
		private void OnGenerate(Texture2D tex)
		{
			...
			for (int x = 0; x < tex.width; x++)
			{
				...
				{
					//currently, there is only one prefab, a cube. 
			...
			Physics.BakeMesh(mesh.GetInstanceID(),false,cookingOptions);//the cookingOptions are set to have Weld Colocated Vertices and EnableMeshCleaning.
			...
			var player = GameObject.FindObjectOfType<GolfMovement>();//This can't be the best way to do this, but I don't know what will trigger MapGeneration in the future.
